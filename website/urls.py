...
urlpatterns = [
    ...
    path('locations/colfax-avenue', views.East, name="colfax-avenue"),
    ...
    path('locations/colfax-avenue/dental-bonding-service', views.dentalbondingservice, name="dental-bonding-service"),
    path('locations/colfax-avenue/dental-bridges-service', views.dentalbridgesservice, name="dental-bridges-service"),
    path('locations/colfax-avenue/dental-checkup-service', views.dentalcheckupservice, name="dental-checkup-service"),
    path('locations/colfax-avenue/dental-crowns-service', views.dentalcrownsservice, name="dental-crowns-service"),
    path('locations/colfax-avenue/dental-implants-service', views.dentalimplantsservice, name="dental-implants-service"),
    path('locations/colfax-avenue/dental-invisalign-service', views.dentalinvisalignservice, name="dental-invisalign-service"),
    path('locations/colfax-avenue/partial-dentures-service', views.partialdenturesser, name="partial-dentures-service"),
    path('locations/colfax-avenue/dental-teeth-whitening-service', views.dentalteethwhiteningser, name="dental-teeth-whitening-service"),
    path('locations/colfax-avenue/dental-white-composite-fillings-service', views.dentalwhitefillingsser, name="dental-white-composite-fillings-service"),
    path('locations/colfax-avenue/wisdom-teeth-removal-service', views.wisdomteethremovalser, name="wisdom-teeth-removal-service"),
    path('locations/colfax-avenue/smile-imaging-technology-service', views.smileimagitechser, name="smile-imaging-technology-service"),
    path('locations/colfax-avenue/general-dentistry-service', views.generaldentistryser, name="general-dentistry-service"),
